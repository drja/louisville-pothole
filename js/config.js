...
dojo.declare("js.config", null, {
    ...
    ApplicationName: "Louisville Pothole Blitz",

    // Set application icon path
    ApplicationIcon: "images/logo.png",

    // Set splash window content - Message that appears when the application starts
    SplashScreenMessage: "<br/><b>Report a pothole:</b><br/><br/>Zoom to street level and click directly on the map to report pothole. Then, provide additional detail and click Submit</br></br>If you find a request has already been submitted, you can click or tap on the existing request, provide additional comments and increase the importance of the request.",

    // Set URL of help page/portal
    HelpURL: "http://louisvilleky.gov//news/pothole-blitz-2015-underway",
    ...
    //DefaultExtent: "-95.271, 38.933, -95.228, 38.976,",
    DefaultExtent: "-9551131,4609166,-9539570,4616016",
    ...
    LocatorSettings: {
        ...
        Locators: [{
            DisplayText: "Address",
            DefaultValue: "527 W Jefferson Street Louisville KY 40202",
